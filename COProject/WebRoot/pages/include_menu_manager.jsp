...
<nav class="navbar navbar-default navbar-inverse navbar-fixed-top">
	...
	<ul class="nav navbar-nav">
		...
		<c:if test="${manager != null}">
			<c:forEach items="${manager.role.groupses}" var="gup">
	...
	<ul class="nav navbar-nav navbar-right">
		<li class="dropdown"><a href="javascript:;"
			class="dropdown-toggle" data-toggle="dropdown"> <i
				class="glyphicon glyphicon-user"></i>&nbsp;${manager.userid}&nbsp;<span
			...
			<ul class="dropdown-menu main-list">
				...
				<li><a href="pages/jsp/manager/manager/ManagerUpdateActionManager!updatePre.action"><i class="glyphicon glyphicon-info-sign"></i>&nbsp;个人资料</a></li>
				<li class="divider"></li>
