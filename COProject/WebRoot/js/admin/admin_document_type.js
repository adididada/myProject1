$(function() {
	...
	$("#myform").validate({
		...
		submitHandler : function(form) {
			...
			$.post("pages/jsp/admin/document/DoctypeActionAdmin!insert.action" ,
					{"doctype.title":title},function(data){
						if (data.flag == true) {
							var dtid = data.dtid ;
							addRow(dtid,title) ;
						}
...
function bindUpdateEvent(dtid) {
	$("#updateBtn-" + dtid).on("click",function() {
		...
		$.post("pages/jsp/admin/document/DoctypeActionAdmin!update.action" ,
				{"doctype.dtid":dtid,"doctype.title":title},function(data){
